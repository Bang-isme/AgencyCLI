...
0. **`docs/AGENT_ONBOARDING.md`** — khung nạp-context + session-tracking (read-order, doc taxonomy, memory model 2 tầng, nhịp slice, templates). Đây là điểm "Start here".
...
- **Baseline verify:** build 16/16, **REAL_EXIT_CODE=0**, **~2144 test** (core **405** · cli 573 · tui **148** · providers 852 · memory 36 · benchmark 18 · workspace 11 · security **39** · tooling 14 · governance 7 · skills-bridge 14 · context 6 · heuristics 6 · browser 5 · telemetry 9). **31 cờ.** **18 tool.**
- **Harness memory/docs (phiên này):** MEMORY.md gọn lại 29.9KB→2.4KB (hết overflow, load đủ) — detail dời xuống topic files; **MỚI `docs/AGENT_ONBOARDING.md`** (khung + templates) + README index "Process & Continuity".
