...
|--------|-----------|
| Conversation, Chat, Shell, Connect, PatchCard (+ harness/production render smoke) | App.tsx, Splash, WelcomeMenu, GoalRunner, ModelsOverlay, McpOverlay, StatusDashboard, SkillsPicker, Approval, RouteOverlay, +20 more |
