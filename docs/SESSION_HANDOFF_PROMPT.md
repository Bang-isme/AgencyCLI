...
- Gate DUY NHẤT: `pnpm verify` (= `pnpm -r build && pnpm -r test`). Baseline: build 16/16 sạch, **~2018 test, exit 0** (core 337 / cli 568 / tui 115 / providers 840 / memory 34 / benchmark 18 / workspace 11 / security 35 / tooling 14 / governance 7 / skills-bridge 13 / context 6 / heuristics 6 / browser 5 / telemetry 9).
