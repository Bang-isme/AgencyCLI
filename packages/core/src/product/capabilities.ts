...
export const MASTER_CAPABILITIES: readonly CapabilityDescriptor[] = [
  ...
  { id: "project", tier: "core", surfaces: ["tui", "cli"], label: "Switch project", description: "Switch the active workspace", category: "workspace", risk: "low", prerequisites: [], icon: "P" },
  { id: "review", tier: "core", surfaces: ["tui", "cli"], label: "Review changes", description: "Inspect working tree, commit, branch, or CI", category: "review", risk: "medium", prerequisites: ["git_repo"], recoveryAction: "Ensure the project is a Git repository.", recovery: "Ensure the project is a Git repository.", icon: "V" },
  { id: "status", tier: "core", surfaces: ["tui", "cli"], label: "Workspace status", description: "Provider, context, index, and runtime health", category: "runtime", risk: "low", prerequisites: [], icon: "i", aliases: ["viewstatus"] },
  ...
  { id: "exit", tier: "core", surfaces: ["tui"], label: "Exit application", description: "Leave the interactive workspace", category: "workspace", risk: "low", prerequisites: [], icon: "x", aliases: ["quit", "q"] },

  // Advanced capabilities
  { id: "skills", tier: "advanced", surfaces: ["tui", "cli"], label: "Skills picker", description: "Browse and inject installed skills", category: "extension", risk: "medium", prerequisites: [], recoveryAction: "Install skills in ~/.cursor/skills", recovery: "Install skills in ~/.cursor/skills", icon: "K", aliases: ["skill"] },
  ...
  { id: "mcp", tier: "advanced", surfaces: ["tui", "cli"], label: "MCP servers", description: "Configure external tool servers", category: "extension", risk: "high", prerequisites: [], recoveryAction: "Configure servers in ~/.agency/mcp.json", recovery: "Configure servers in ~/.agency/mcp.json", icon: "m" },
  { id: "theme", tier: "advanced", surfaces: ["tui"], label: "Switch theme", description: "Change terminal appearance", category: "workspace", risk: "low", prerequisites: [], recoveryAction: "Available themes: agency, daylight", recovery: "Available themes: agency, daylight", icon: "T", aliases: ["themes"] },
  ...
  { id: "goal", tier: "advanced", surfaces: ["tui", "cli"], label: "Goal runner", description: "Run a long autonomous task", category: "automation", risk: "high", prerequisites: ["provider_configured"], recoveryAction: "Check goal task parameters", recovery: "Check goal task parameters", icon: "G" },
  { id: "team", tier: "advanced", surfaces: ["tui", "cli"], label: "Team dispatch", description: "Manage subagent team dispatch and multi-agent coordination", category: "runtime", risk: "high", prerequisites: [], icon: "T" },
  { id: "tasks", tier: "advanced", surfaces: ["tui", "cli"], label: "Tasks manager", description: "Manage plan and background tasks", category: "automation", risk: "low", prerequisites: [], icon: "t", aliases: ["task"] },
  { id: "workflow", tier: "advanced", surfaces: ["tui", "cli"], label: "Workflows", description: "Execute structured workflow packs and pipelines", category: "automation", risk: "medium", prerequisites: [], icon: "W" },
  { id: "schedule", tier: "advanced", surfaces: ["tui", "cli"], label: "Task schedule", description: "Create recurring tasks", category: "automation", risk: "medium", prerequisites: [], recoveryAction: "Format: /schedule every 30m task", recovery: "Format: /schedule every 30m task", icon: "s" },
  { id: "agents", tier: "advanced", surfaces: ["tui", "cli"], label: "Subagents inspector", description: "Inspect delegated work", category: "runtime", risk: "medium", prerequisites: [], icon: "a" },
  ...
  { id: "dashboard", tier: "advanced", surfaces: ["tui", "cli"], label: "Knowledge dashboard", description: "Open memory and graph dashboard", category: "runtime", risk: "low", prerequisites: [], recoveryAction: "Run /index to build dashboard HTML", recovery: "Run /index to build dashboard HTML", icon: "D", aliases: ["memory", "graph"] },
  { id: "browser", tier: "advanced", surfaces: ["tui", "cli"], label: "Browser tool", description: "Launch headless browser for scraping & search", category: "tool", risk: "medium", prerequisites: [], icon: "B" },
  { id: "replay", tier: "advanced", surfaces: ["cli"], label: "Replay session", description: "Replay session transcripts or test regression suite", category: "runtime", risk: "low", prerequisites: [], icon: "R", aliases: ["replay-regression"] },
  { id: "eval", tier: "advanced", surfaces: ["cli"], label: "Evaluate model", description: "Evaluate prompt outputs and model benchmark gates", category: "runtime", risk: "low", prerequisites: [], icon: "E" },
  { id: "benchmark", tier: "advanced", surfaces: ["cli"], label: "Run benchmark", description: "Execute benchmark test suites evaluating model quality", category: "runtime", risk: "low", prerequisites: [], icon: "b" },
  { id: "server", tier: "advanced", surfaces: ["cli"], label: "Server daemon", description: "Launch background Agency API server daemon", category: "runtime", risk: "medium", prerequisites: [], icon: "S" },
  { id: "handover", tier: "advanced", surfaces: ["tui", "cli"], label: "Handover report", description: "Generate 5-component handoff report for team handover", category: "workspace", risk: "low", prerequisites: [], icon: "H" },
