#!/usr/bin/env python3
"""
Analyze project coding patterns and write project-state project-profile.json.
"""
...
def main() -> int:
    ...
    output_path = Path(args.output).expanduser().resolve() if args.output else project_state_path(project_root, "project-profile.json")
