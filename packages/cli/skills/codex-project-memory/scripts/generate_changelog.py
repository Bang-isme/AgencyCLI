...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            '  python generate_changelog.py --project-root <project-root> --since "2026-02-01"\n'
            '  python generate_changelog.py --project-root <project-root> --version "v1.2.0" --output ".agency/changelog.md"\n'
