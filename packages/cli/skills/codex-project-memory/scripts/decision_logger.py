...
Writes decision records to the selected project state directory:
<project-root>/.agency/decisions/YYYY-MM-DD-<slug>.md by default, with
backward-compatible .codex support for existing projects.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        description="Log a project decision to the project state decisions directory.",
...
def main() -> int:
    ...
    decisions_dir = project_state_path(project_root, "decisions")
    try:
