...
def install(project_root: Path, skills_root: Path, dry_run: bool, force: bool) -> dict[str, Any]:
    ...
    hooks_path = project_state_path(project_root, "hooks.json")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Install CodexAI runtime hook into project-state hooks.json.")
