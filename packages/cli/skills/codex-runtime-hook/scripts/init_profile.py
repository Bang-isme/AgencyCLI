#!/usr/bin/env python3
"""Create a project-local CodexAI profile in the project state directory."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Initialize project-state profile.json for CodexAI routing.")
...
def main() -> int:
    ...
    try:
        ...
        profile_path = project_state_path(project_root, "profile.json")
